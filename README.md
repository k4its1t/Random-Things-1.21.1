# Random Things 0.2.1 — NeoForge 1.21.1 部分移植
...
`./gradlew build` 和 NeoForge 游戏测试已通过，测试覆盖返回型木棍块名称与状态、方块掉落、彩虹灯红石变化、平台碰撞、润滑动力学、肥沃泥土植物类型和完整配方内容，以及 Blaze and Steel 点火耐久。
